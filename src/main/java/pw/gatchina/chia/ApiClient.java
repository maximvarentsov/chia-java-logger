...
public class ApiClient {
    ...
    public static GetWalletBalance getWalletBalance(@NotNull final String host, final int walledId) {
    ...
    public static GetBlockchainState getBlockchainState(@NotNull final String host) {
    ...
    public static GetPlots getPlots(@NotNull final String host) {
